...
### Najpopularniejsze województwa według kategorii
...
offers_pl %>%
  select(title) %>%
  mutate(tilte = str_to_lower(title)) %>%
  filter(str_detect(title, "scrum master|product owner|project manager|kierownik projektu")) %>%
...
### Zarobki versus poziom stanowiska
